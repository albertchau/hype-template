    ...
    */
    Preloader: function() {
        $(window).load(function() {
            ...
            setTimeout(function(){$('#logo').addClass('animated fadeInDown')},400);
            setTimeout(function(){$('#logo_header').addClass('animated fadeInDown')},400);
            setTimeout(function(){$('#slogan').addClass('animated fadeInDown')},400);
            setTimeout(function(){$('#home_image').addClass('animated fadeInUp')},500);
        })
    },
